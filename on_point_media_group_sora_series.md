# ON POINT MEDIA GROUP: THE ORIGIN
## A Sora AI Video Series - 20 Episodes

---

# SERIES BIBLE & CHARACTER CONSISTENCY GUIDE

## CRITICAL SORA FORMATTING NOTES
- Each script is designed for 12-15 second clips
- Dialogue limited to 25-35 words per episode for timing
- Character descriptions MUST remain identical across all episodes
- Visual anchors repeated for consistency
- Speaker labels clearly marked with [CHARACTER NAME:]

---

## CHARACTER PROFILES

### JASON ROBERTS (CEO / "Special Advisor")
**Sora Character Code:** @ct_events2026
**Public Identity:** Special Advisor, On Point Media Group
**True Identity:** Founder, CEO, and sole owner of the trillion-dollar On Point Media Group conglomerate
**Background:** Tech genius, AI pioneer, built fortune in mobile technology before creating OPMG
**Demeanor:** Calm, calculated, always three steps ahead, speaks with quiet authority

---

### MAYA SANTOS (Executive Assistant / Gatekeeper)
**VISUAL DESCRIPTION (USE EXACTLY IN EVERY SCENE):**
"Afro-Latina woman, early 30s, voluminous curly dark hair, athletic thick build, striking blue eyes, fitted professional attire, confident posture, commanding presence"

**Role:** Executive Assistant to "The CEO" - the only person who knows Jason's true identity
**Personality:** Ruthless protector, strategically seductive, razor-sharp intellect, fiercely loyal
**Function:** Manages all access, schedules, travel, and maintains the deception
**Tactics:** Uses her magnetic presence to control rooms and redirect attention away from Jason

---

### THE COMPANY: ON POINT MEDIA GROUP (OPMG)
**Public Perception:** A subsidiary of an unnamed parent corporation
**Reality:** A self-contained trillion-dollar empire spanning:
...
- Product Development
- Political Strategy
- Nonprofit & Philanthropy (sustainability focus)

**Key Secret:** All divisions operate independently. No one sees the full picture except Jason, Maya, and a select few executives.
...
# SORA IMPLEMENTATION NOTES

## Consistency Keys for Sora:
...
- "stunning fitted gown" (gala/event)

## End Card Specifications:
- Background: Pure black (#000000)
- Text: White (#FFFFFF)
- Font style: Minimalist sans-serif
- Animation: Fade in over 0.5 seconds
...
*Series created for Sora AI video generation*
*Character @ct_events2026 property of creator*
*On Point Media Group - Fictional Entity*
